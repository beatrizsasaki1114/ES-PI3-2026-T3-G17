        ...
        child: ListView(
          ...
          children: [
            ...
            _buildDrawerItem(
              ...
              text: 'Investimentos',
              // NAVEGAÇÃO ATUALIZADA PARA BALCÃO DE TOKENS
              onTap: () => Navigator.push(
                context,
                  ...
                  child: Column(
                    children: [
                      SwitchListTile(
                        ...
                        // Beatriz Naomi - Lógica do botão para ativar 2FA
                        onChanged: (v) async {
                          if (v) {
                            final user = FirebaseAuth.instance.currentUser;
                            // Força o Firebase a checar se o e-mail foi verificado agora
                            await user?.reload();
                      ...
                      SwitchListTile(
                        ...
                        onChanged: (v) =>
                            setState(() => receiveNotifications = v),
                        title: Text(
                          'Notificações',
                          style: GoogleFonts.poppins(
                            textStyle: const TextStyle(
